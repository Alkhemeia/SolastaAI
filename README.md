...
3. **Granular Categorized Spell & Skill Toggles:**
   ...
   - **Druid Options (`AI: Druid`):**
     - **`[+]` 🔮 Cantrips / Zaubertricks:** `Shillelagh / Zauberstock`, `Guidance / Göttliche Führung`, `Produce Flame`, `Thorn Whip`, `Poison Spray / Giftsprühen`, `Poison Sting / Giftiger Stachel`, `Chill Touch / Kalte Hand`, `Resist Elements`
